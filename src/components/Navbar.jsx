...
const Navbar = () => {
  return (
<>
<section className='h-15 bg-amber-100 md:w-[100%]  flex items-center gap-25 md:justify-between pr-0 pl-5  md:pr-10 md:pl-10 z-10 sticky top-0 left-0 right-0'>
...
<div className='group border rounded-2xl h-8 md:flex justify-center items-center  p-3 hidden '>
     ...
     <section className='h-12 md:h-18 bg-blue-300   flex  items-center md:justify-center pl-5 sticky top-0 left-0 right-0'>
